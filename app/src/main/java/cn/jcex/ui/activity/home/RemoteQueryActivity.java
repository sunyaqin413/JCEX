...
import cn.jcex.ui.fragment.home.RemoteQueryFragment;
...
public class RemoteQueryActivity extends BaseActivity {
    @Override
    protected void initView() {
        setContentView(R.layout.activity_fragment_instance);
      addFragment(FragmentInstanceManager.getInstance().getFragment(RemoteQueryFragment.class),false);
    }
