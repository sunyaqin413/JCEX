...
import cn.jcex.ui.fragment.home.ForecastOrderFragment;
...
public class ForecastOrderActivity extends BaseActivity {
    @Override
    protected void initView() {
        setContentView(R.layout.activity_fragment_instance);
      addFragment(FragmentInstanceManager.getInstance().getFragment(ForecastOrderFragment.class),false);
    }
