...
import cn.jcex.ui.fragment.mine.ServiceOnlineFragment;
...
public class ServiceOnlineActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        addFragment(FragmentInstanceManager.getInstance().getFragment(ServiceOnlineFragment.class),false);
