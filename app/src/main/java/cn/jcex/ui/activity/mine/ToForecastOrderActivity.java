...
import cn.jcex.ui.fragment.mine.ToForecastOrdersFragment;

/**
 * 类描述: 我的-待预报运单activity
 *
 * @author sunyaqin
 * @version 1.0
...
public class ToForecastOrderActivity extends BaseActivity {
    @Override
    protected void initView() {
        setContentView(R.layout.activity_fragment_instance);
        addFragment(FragmentInstanceManager.getInstance().getFragment(ToForecastOrdersFragment.class),false);
    }
