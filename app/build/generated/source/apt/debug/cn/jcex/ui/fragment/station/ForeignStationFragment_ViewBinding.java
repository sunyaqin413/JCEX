...
public class ForeignStationFragment_ViewBinding<T extends ForeignStationFragment> implements Unbinder {
  protected T target;

  public ForeignStationFragment_ViewBinding(T target, Finder finder, Object source) {
    this.target = target;
